...
export class EditIssueComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.issueModal = {
      ...
      issueDescription: '',
      issue_requested_by: '',
      issue_requested_date: (BigInt(0)),
      issue_respond_by: '',
      issue_respond_date: (BigInt(0)),
      issue_closed_by: '',
      issue_closed_date: (BigInt(0)),
      issuePriority: 0,
      issueStatus: '',
      ticket: '',
    ...
    if (this.selectedIssue >0) {
      this.issueTrackingService.GetIssueById(this.selectedIssue).subscribe(res=>{
        this.issueModal = {
          ...
          issue_requested_by: res.issue_requested_by,
          issue_requested_date: res.issue_requested_date,
          issue_respond_by: res.issue_respond_by,
          issue_respond_date: res.issue_respond_date,
          issue_closed_by: res.issue_closed_by,
          issue_closed_date:res.issue_closed_date,
